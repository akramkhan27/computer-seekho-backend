...
public class BatchController {
    ...
    private BatchResponseDTO convertToResponseDTO(Batch batch) {
        ...
        dto.setBatchStartTime(batch.getBatchStartTime());
        dto.setBatchEndTime(batch.getBatchEndTime());
    ...
    private Batch convertCreateRequestToEntity(BatchCreateRequestDTO dto) {
        ...
        batch.setBatchStartTime(dto.getBatchStartTime());
        batch.setBatchEndTime(dto.getBatchEndTime());
